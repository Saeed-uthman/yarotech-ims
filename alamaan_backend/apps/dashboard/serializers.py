...
class DashboardSummarySerializer(serializers.Serializer):
    ...
    current_business_funds = serializers.DecimalField(max_digits=18, decimal_places=2)
    opening_balance = serializers.DecimalField(max_digits=18, decimal_places=2)
    owner_capital = serializers.DecimalField(max_digits=18, decimal_places=2)
    owner_withdrawals = serializers.DecimalField(max_digits=18, decimal_places=2)
