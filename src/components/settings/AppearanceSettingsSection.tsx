    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 pt-4 border-t border-slate-200">
        ...
        <div className="bg-white p-4 rounded-xl border border-slate-200 space-y-2">
          <label htmlFor="settings-language-select" className="text-xs font-semibold text-slate-900 flex items-center gap-1.5">
          ...
          <select
            ...
            className="w-full px-3 py-2 text-sm rounded-lg border border-slate-300 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 text-slate-900"
          >
        ...
        <div className="bg-white p-4 rounded-xl border border-slate-200 space-y-2">
          <label htmlFor="settings-session-timeout" className="text-xs font-semibold text-slate-900 flex items-center gap-1.5">
